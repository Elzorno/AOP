...
cat > "$ROOT_DIR/app/Http/Controllers/Aop/Schedule/SchedulePublishController.php" <<'PHP'
<?php
...
chown www-data:www-data "$ROOT_DIR/app/Http/Controllers/Aop/Schedule/SchedulePublishController.php"
chmod 644 "$ROOT_DIR/app/Http/Controllers/Aop/Schedule/SchedulePublishController.php"

echo "OK: Applied Phase 8.1 hotfix (ZipArchive addFile existence check)."
